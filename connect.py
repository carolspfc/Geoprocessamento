...
class ConnectPlugin:
    ...
    def initGui(self):
        ...
        self.action.setToolTip('Abrir/Fechar Connect  (Ctrl+L)')
...
class ConnectWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        hl.addWidget(h1)
        h2 = QLabel('Setas cima/baixo navegam  |  Ctrl+L abre/fecha')
